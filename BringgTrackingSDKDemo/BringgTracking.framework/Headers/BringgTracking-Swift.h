...
@interface NSCharacterSet (SWIFT_EXTENSION(BringgTracking))
@end


@interface NSData (SWIFT_EXTENSION(BringgTracking))
@end


@interface NSDictionary (SWIFT_EXTENSION(BringgTracking))
@end


SWIFT_CLASS("_TtC14BringgTracking7SSLCert")
...
SWIFT_CLASS("_TtC14BringgTracking11SSLSecurity")
...
SWIFT_CLASS("_TtC14BringgTracking16SocketAckEmitter")
...
SWIFT_CLASS("_TtC14BringgTracking14SocketAnyEvent")
...
/// 
/// </code>
SWIFT_CLASS("_TtC14BringgTracking19SocketClientManager")
...
SWIFT_PROTOCOL("_TtP14BringgTracking16SocketEngineSpec_")
...
SWIFT_CLASS("_TtC14BringgTracking12SocketEngine")
...
SWIFT_PROTOCOL("_TtP14BringgTracking18SocketEngineClient_")
@protocol SocketEngineClient
...
SWIFT_CLASS("_TtC14BringgTracking14SocketIOClient")
...
@interface SocketIOClient (SWIFT_EXTENSION(BringgTracking))
@end
...
SWIFT_CLASS("_TtC14BringgTracking9WebSocket")
